          ...
          {ActivePage ? (
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-slate-800">
                Modulo {activeTab.toUpperCase()} in sviluppo
              </h2>
              <p className="text-slate-400 max-w-md mt-4 font-medium">
                Stiamo ottimizzando questa funzionalità. Torna presto!
              </p>
              <button
                onClick={() => setActiveTab('dashboard')}
                className="mt-8 px-8 py-3 bg-gradient-to-r from-pink-200 to-purple-200 text-pink-500 font-bold rounded-2xl border border-pink-100 hover:shadow-lg transition-all"
              >
          ...
          >
            <div className="p-5 border-b border-pink-50 flex justify-between items-center bg-white/50">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-slate-700">Menta AI</span>
              </div>
            ...
            <div className="flex-1 p-6 overflow-y-auto min-h-[300px]">
              <div className="bg-pink-50/30 p-5 rounded-[24px] text-sm border border-pink-50 text-slate-600 leading-relaxed">
                <p>Ciao! Sono Menta AI. Come posso aiutarti oggi? ✨</p>
              </div>
            </div>
